      ...
      <v-row class="solution">
        <v-col cols="12" md="8">
          <v-hover v-slot:default="{ hover }">
            ...
            >
              <v-list-item class="ml-8 mt-10">
                <img src="../../assets/servByte/thumbs-up-orange.svg" class="success-circle" alt=""/>
              </v-list-item>
              <div>
                <v-list-item>
                  <v-list-item-content>
                    <v-list-item>
                      <v-card-text class="headline ml-0 mt-2">
                        <h1
                    ...
                    <v-list-item>
                      <v-card-text
                          ...
                          :style="{'font-family': 'IBM Plex Sans', 'font-size': '24px', 'line-height': '42px'}"
